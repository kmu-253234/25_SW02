...
#define _DUTY_MIN 150 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1500 // servo neutral position (90 degree)
#define _DUTY_MAX 2850// servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if (dist_ema <= _DIST_MIN) {
    ...
    int duty = int(150 + ((dist_ema - 180.0)*15));
